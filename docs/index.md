...
#### 主な論点
* [a-適正な範囲・方法での利用](./jpn/detail/01.md#a-適正な範囲方法での利用)
* [b-人間の判断の介在](./jpn/detail/01.md#b-人間の判断の介在)
* [c-関係者間の協力](./jpn/detail/01.md#c-関係者間の協力)
* [d-aaa](.jpn/detail/01.md#d-・)
...
#### 主な論点
* [a-AIの学習等に用いるデータの質への留意](./jpn/detail/02.md#a-ＡＩの学習等に用いるデータの質への留意)
* [b-不正確又は不適切なデータの学習等によるAIのセキュリティ脆弱性への留意](./jpn/detail/02.md#b-不正確又は不適切なデータの学習等によるＡＩのセキュリティ脆弱性への留意)
...
* [c-AIネットワーク化により惹起・増幅される課題への留意](./jpn/detail/03.md#c-ＡＩネットワーク化により惹起増幅される課題への留意)
...
#### 主な論点
* [a-人の生命・身体・財産への配慮](./jpn/detail/04.md#a-人の生命身体財産への配慮)
...
* [c-AIの学習モデルに対するセキュリティ脆弱性への留意](./jpn/detail/05.md#c-ＡＩの学習モデルに対するセキュリティ脆弱性への留意)
...
#### 主な論点
* [a-AI利活用における最終利用者及び第三者のプライバシーの尊重](./jpn/detail/06.md#a-ＡＩ利活用における最終利用者及び第三者のプライバシーの尊重)
* [b-パーソナルデータの収集・前処理・提供等におけるプライバシーの尊重](./jpn/detail/06.md#b-パーソナルデータの収集前処理提供等におけるプライバシーの尊重)
...
* [b-AIによる意思決定・感情の操作等への留意](./jpn/detail/07.md#b-ＡＩによる意思決定感情の操作等への留意)
* [c-AIと人間の脳・身体を連携する際の生命倫理等の議論の参照](./jpn/detail/07.md#c-ＡＩと人間の脳身体を連携する際の生命倫理等の議論の参照)
* [d-AIを利用したプロファイリングを行う場合における不利益への配慮](./jpn/detail/07.md#d-ＡＩを利用したプロファイリングを行う場合における不利益への配慮)
...
#### 主な論点
* [a-AIの学習等に用いられるデータの代表性への留意](./jpn/detail/08.md#a-ＡＩの学習等に用いられるデータの代表性への留意)
...
#### 主な論点
* [a-AIの入出力等のログの記録・保存](./jpn/detail/09.md#a-ＡＩの入出力等のログの記録保存)
...
* [b-AIに関する利用方針の通知・公表](./jpn/detail/10.md#b-ＡＩに関する利用方針の通知公表)
